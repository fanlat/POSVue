...
import { useProductStore } from '@/stores/products'; // importamos el store de productos
import { formatCurrency } from '@/helpers' // importamos la funcion formatCurrency


const products = useProductStore() // obtenemos el store de productos
...
<template>
    <li 
        ...
        <div class="space-y-2 flex-auto">
            ...
            <!-- llamamos a la funcion formatCurrency y le pasamos el precio del producto -->
